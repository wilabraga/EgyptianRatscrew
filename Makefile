...
OFILES = gba.o font.o draw.o logic.o main.o graphics.o images/sprites.o images/start_screen.o images/board.o images/zvi.o images/buzz.o images/cs2110.o images/uga.o
